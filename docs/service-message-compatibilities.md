...
### Tsurugi Release 1.12.0

SMV             | Tsubakuro-Java version | Tsubakuro-Rust version
--------------- | ---------------------- | ----------------------
`sql-2.1`       | `1.16.0`               | `0.10.0`
`system-0.0`    | `1.13.0`               | `0.7.0`
`wire-2.1`      | `1.16.0`               | `0.10.0`
`broker-0.2`    | `1.16.0`               | `0.10.0`
`datastore-0.0` | `1.0.1`                | `-`
`kvs-0.0`       | `1.0.1`                | `-`
`auth-0.0`      | `1.0.1`                | `-`
`debug-0.0`     | `1.1.0`                | `-`

### Tsurugi Release 1.11.2
...
SMV             | Tsubakuro-Java version | Tsubakuro-Rust version
--------------- | ---------------------- | ----------------------
`sql-1.6`       | `1.10.0`               | `0.3.0`
`datastore-0.0` | `1.0.1`                | `-`
`kvs-0.0`       | `1.0.1`                | `-`
`auth-0.0`      | `1.0.1`                | `-`
`debug-0.0`     | `1.1.0`                | `-`

### Tsurugi Release 1.6.0
